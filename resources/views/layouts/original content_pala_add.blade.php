...
<div class="one">	
	...
	<div class="col-md-2">
			<div class="input-group">
				...
				<input  name="tin" type="text" placeholder="tin" class="form-control input-md">
			</div>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-md-4">
			...
			<label class="form-check-label" for="self_employed">Self Employed</label>
  			<input class="form-check-input"  name="self_employed" type="checkbox" value="self_employed">  					
			</div>	
		</div>								
		</div>
	<!--ytj-->
	...
	<table class="table" border="1" width="400">	
		...
		<tbody>
			<tr>
				...
				<td class="mat_count"><input id="1_mat_5"class="col-md-6"	type="text"  name="re" ></td>
...
(attach financial statement)</label>
	...
	<!--Total Assets a.-->
	<label class="radio-inline" for="Completed">Total Assets <b>a.</b></label>
...
<table class="table" border="1" width="400">
	...
	<div class="form-group">
		...
		<div class="col-md-4">
			<div class="input-group">
				...
				<input id="acctliabilities2" name="acctno" type="text" placeholder="Acct. no." class="form-control input-md">
			</div>
		</div>
		</div>
	<div class="form-group">
	...
	<div class="col-md-4">
		...
		<td>Net Worth => (a minus b)<input id="difference" name="difference" type="text" placeholder="$" class="form-control input-md"></td>
		<td>Total Liabilities <b>b.</b>
...
<tbody>
	<tr>
	<td width="400" >Property Address</td>
	<td>Type of Property</td>
	<td>Present Market Value</td>
	<td>Amount of <br> Mortgages & Liens</td>
	<td>Rental Income</td>
	<td>Mortgage Payments</td>
	<td>Maintenance <br> Taxes & Misc.</td>
	...
	<td>
		...
		<div class="col-md-3  ">
				<input id="Subject Property Address" name="spa_street1" type="text" placeholder="Street" class="form-control input-md ">
			</div>
		<div class="col-md-3">
		...
		<td class="mat_sum"><input id="1_mat_1" class="col-md-12" type="text"  name="a1" ></td>
		<td class="mat_sum"><input id="1_mat_2" class="col-md-12" type="text"  name="b1"></td>
		<td class="mat_sum"><input id="1_mat_3" class="col-md-12" type="text"  name="c1"></td>
		<td class="mat_sum"><input id="1_mat_4" class="col-md-12" type="text"  name="d1"></td>
		<td class="mat_sum"><input id="1_mat_5" class="col-md-12" type="text"  name="e1"></td>
		<td class="mat_sum"><input id="1_mat_6" class="col-md-12" type="text"  name="f1"></td>
		<td class="mat_sum"><input id="1_mat_7" class="col-md-12" type="text"  name="g1"></td>
	</tr>
	<tr>
		<td>
	<div class="col-md-3  ">
		...
		<td class="mat_sum"><input id="2_mat_1" class="col-md-12" type="text"  name="a2" ></td>
		<td class="mat_sum"><input id="2_mat_2" class="col-md-12" type="text"  name="b2"></td>
		<td class="mat_sum"><input id="2_mat_3" class="col-md-12" type="text"  name="c2"></td>
		<td class="mat_sum"><input id="2_mat_4" class="col-md-12" type="text"  name="d2"></td>
		<td class="mat_sum"><input id="2_mat_5" class="col-md-12" type="text"  name="e2"></td>
		<td class="mat_sum"><input id="2_mat_6" class="col-md-12" type="text"  name="f2"></td>
		<td class="mat_sum"><input id="2_mat_7" class="col-md-12" type="text"  name="g2"></td>
	</tr>
	<tr>
	<td>
		<div class="col-md-3  ">
	...
	<td class="mat_sum"><input id="3_mat_1" class="col-md-12" type="text"  name="a3" ></td>
	<td class="mat_sum"><input id="3_mat_2" class="col-md-12" type="text"  name="b3"></td>
	<td class="mat_sum"><input id="3_mat_3" class="col-md-12" type="text"  name="c3"></td>
	<td class="mat_sum"><input id="3_mat_4" class="col-md-12" type="text"  name="d3"></td>
	<td class="mat_sum"><input id="3_mat_5" class="col-md-12" type="text"  name="e3"></td>
	<td class="mat_sum"><input id="3_mat_6" class="col-md-12" type="text"  name="f3"></td>
	<td class="mat_sum"><input id="3_mat_7" class="col-md-12" type="text"  name="g3"></td>
	</tr>
	<tr>
	...
	<td class="mat_sum"><input id="4_mat_1" class="col-md-12" type="text"  name="a4" ></td>
	<td class="mat_sum"><input id="4_mat_2" class="col-md-12" type="text"  name="b4"></td>
	<td class="mat_sum"><input id="4_mat_3" class="col-md-12" type="text"  name="c4"></td>
	<td class="mat_sum"><input id="4_mat_4" class="col-md-12" type="text"  name="d4"></td>
	<td class="mat_sum"><input id="4_mat_5" class="col-md-12" type="text"  name="e4"></td>
	<td class="mat_sum"><input id="4_mat_6" class="col-md-12" type="text"  name="f4"></td>
	<td class="mat_sum"><input id="4_mat_7" class="col-md-12" type="text"  name="g4"></td>
	</tr>
	<tr>
	<td>
		<div class="col-md-3  ">
				<input id="Subject Property Address" name="spa_street5" type="text" placeholder="Street" class="form-control input-md ">
			</div>
		<div class="col-md-3 col-xs-4">
				<input id="Subject Property Address" name="spa_city5" type="text" placeholder="City" class="form-control input-md ">
			</div>
		<div class="col-md-3 col-xs-4">
				<input id="Subject Property Address" name="spa_state5" type="text" placeholder="State" class="form-control input-md ">
			</div>
		<div class="col-md-3 col-xs-4">
				<input id="Subject Property Address" name="spa_zip5" type="text" placeholder="Zip" class="form-control input-md ">
			</div>
	</td>
	<td class="mat_sum"><input id="5_mat_1" class="col-md-12" type="text"  name="a5" ></td>
	<td class="mat_sum"><input id="5_mat_2" class="col-md-12" type="text"  name="b5"></td>
	<td class="mat_sum"><input id="5_mat_3" class="col-md-12" type="text"  name="c5"></td>
	<td class="mat_sum"><input id="5_mat_4" class="col-md-12"  type="text"  name="d5"></td>
	<td class="mat_sum"><input id="5_mat_5" class="col-md-12" type="text"  name="e5"></td>
	<td class="mat_sum"><input id="5_mat_6" class="col-md-12" type="text"  name="f5"></td>
	<td class="mat_sum"><input id="5_mat_7" class="col-md-12" type="text"  name="g5"></td>
	</tr>
	<tr>
	<td>
		
	</td>
	<td><input type="text"  id="count_1" class="col-md-12" name="col_1"></td>
	<td><input type="text"  id="count_2" class="col-md-12" name="col_2"></td>
	<td><input type="text"  id="count_3" class="col-md-12" name="col_3"></td>
	<td><input type="text"  id="count_4" class="col-md-12" name="col_4"></td>
	<td><input type="text"  id="count_5" class="col-md-12" name="col_5"></td>
	<td><input type="text"  id="count_6" class="col-md-12" name="col_6"></td>
	<td><input type="text"  id="count_7" class="col-md-12" name="col_7"></td>
	</tr>
</tbody>
</table>	
	<div class="form-group">
			...
			<div class="col-md-4">
				<label class="radio-inline" for="properties-0">
					<input type="radio" name="properties" id="properties-0" value="1" checked="checked">
					Yes
				</label>
				<label class="radio-inline" for="properties-1">
					<input type="radio" name="properties" id="properties-1" value="2">
					No
				</label>
...
<div class="form-group">					
	...
	<div class="col-md-3">
			...
			<input id="nameandtitle" name="nameandtitle1" type="text" placeholder="Name and Title" class=" form-control ">
			</div>			
			</div>
			
	<div class="col-md-5">
				<label class="radio-inline" for="amortization-0">
					<input type="radio" name="amortization" id="amortization-0" value="1" checked="checked">
					Borrower
				</label>
				<label class="radio-inline" for="amortization-1">
					<input type="radio" name="amortization" id="amortization-1" value="2">
					Guarantor
				</label>
			</div>					
	</div>
	...
	<label class="col-md-4 text-center"  for="mailingaddress">Mailing Address</label>
		<div class="col-md-2">
		<input id="mailingaddress" name="las_street" type="text" placeholder="Street" class="form-control input-md ">
		</div>
		<div class="col-md-2">
		<input id="mailingaddresss" name="las_city" type="text" placeholder="City" class="form-control input-md ">
		</div>
		<div class="col-md-2">
		<input id="mailingaddress" name="las_state" type="text" placeholder="State" class="form-control input-md ">
		</div>
		<div class="col-md-2">
		<input id="mailingaddress" name="las_zip" type="text" placeholder="Zip" class="form-control input-md ">
		</div>
...
<div class="form-group">
		...
		<div class="col-md-4">
			<div class="input-group">
				...
				<input  name="tin1" type="text" placeholder="tin1" class="form-control input-md">
			</div>
		</div>		
	</div>
...
<div class="form-group">					
	...
	<div class="col-md-5">
				<label class="radio-inline" for="las-0">
					<input type="radio" name="las" id="las-0" value="1" checked="checked">
					Borrower
				</label>
				<label class="radio-inline" for="las-1">
					<input type="radio" name="las" id="las-1" value="2">
					Guarantor
				</label>
			</div>					
	</div>
...
<div class="form-group">
		...
		<div class="col-md-4">
			<div class="input-group">
				...
				<input  name="tin2" type="text" placeholder="tin2" class="form-control input-md">
			</div>
		</div>		
	</div>
...
<div class="form-group">
		...
		<div class="col-md-4">
			<div class="input-group">
				...
				<input  name="tin3" type="text" placeholder="tin3" class="form-control input-md">
			</div>
		</div>		
	</div>
...
<div class="col-md-5">
				<label class="radio-inline" for="questions">
					<input type="radio" name="questions" id="questions-0" value="1" checked="checked">
					Yes
				</label><br>
				<label class="radio-inline" for="questions">
					<input type="radio" name="questions" id="questions-1" value="2">
					No
				</label>
</div>
</td>
...
<div class="form-group">
		...
		<div class="col-xs-8">
			...
			<label class="radio-inline" for="info">
				<input type="checkbox" name="info"  placeholder="I do not wish to furnish this information" id="info" value="1" checked="checked">
...
<td>
	<div class="form-group">
		...
		<div class="col-xs-8">
			...
			<label class="radio-inline" for="info">
				<input type="checkbox" name="info1"  placeholder="I do not wish to furnish this information" id="info" value="1" checked="checked">
				I do not wish to furnish this information
			</label>
		</div>
</div>
...
<div class="col-md-8">
			<label class="radio-inline" for="ethniccity-10">
				<input type="radio" name="ethniccity1" id="ethniccity-10" value="1" checked="checked">
				Hispanic or Latino
			</label>
			<label class="radio-inline" for="ethniccity-11">
				<input type="radio" name="ethniccity2" id="ethniccity-11" value="2">
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			...
			<label class="radio-inline" for="ethniccity-1">
				<input type="radio" name="ethniccity" id="ethniccity-1" value="2">
				Not Hispanic or Latin
			</label>
        </div>		
     	</div>
...
<div class="form-group">
			...
			<label class="radio-inline" for="Race">
				<input type="radio" name="race1" id="race" value="1" checked="checked">
				American Indian or Alaska Native
			</label><br>
			<label class="radio-inline" for="Race">
				<input type="radio" name="race2" id="race1" value="2">
				Asian
				</label><br>
			<label class="radio-inline" for="Race">
				<input type="radio" name="race3" id="race2" value="3">
				Black or African American
				</label><br>
			<label class="radio-inline" for="Race">
				<input type="radio" name="race4" id="race3" value="4"> 
				Native Hawaiian or Other Pacific Islander
				</label><br>
			<label class="radio-inline" for="Race">
				<input type="radio" name="race5" id="race4" value="5">
				White
			</label><br>
...
<div class="form-group">
			...
			<div class="col-md-8">
			<label class="radio-inline" for="Race">
				<input type="radio" name="race" id="race6" value="1" checked="checked">
				American Indian or Alaska Native
			</label><br>
			<label class="radio-inline" for="Race">
				<input type="radio" name="race" id="race6" value="2">
				Asian
				</label><br>
			<label class="radio-inline" for="Race">
				<input type="radio" name="race" id="race2" value="3">
				Black or African American
				</label><br>
			<label class="radio-inline" for="Race">
				<input type="radio" name="race" id="race3" value="4"> 
				Native Hawaiian or Other Pacific Islander
				</label><br>
			<label class="radio-inline" for="Race">
				<input type="radio" name="race" id="race4" value="5">
				White
			</label><br>			
		</div>
	</div>
...
<div class="col-md-8">
			<label class="radio-inline" for="ethniccity-10">
				<input type="radio" name="sex11" id="sex-11" value="1" checked="checked">
				Female
			</label>
			<label class="radio-inline" for="ethniccity-11">
				<input type="radio" name="sex12" id="sex-12" value="2">
				Male
			</label>
...
<div class="form-group">
		...
		<div class="col-md-4">
			<label class="radio-inline" for="information">
				<input type="radio" name="loan_type" id="information" value="1" checked="checked">
				In a face-to-face interview
			</label><br>
			<label class="radio-inline" for="information">
				<input type="radio" name="loan_type" id="information1" value="2">
				In a telephone interview
				</label><br>
			<label class="radio-inline" for="information">
				<input type="radio" name="loan_type" id="information2" value="3">
				By the applicant and submitted by fax or mail
				</label><br>
			<label class="radio-inline" for="information">
				<input type="radio" name="loan_type" id="information3" value="4"> 
